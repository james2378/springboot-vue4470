			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="教师姓名" prop="teachers_name">
					...
					<div v-else-if="$check_field('get','teachers_name')">{{form_sub['teachers_name']}}</div>
								...
								<el-col v-if="user_group === '管理员' || $check_field('get','gender_of_teachers') || $check_field('add','gender_of_teachers') || $check_field('set','gender_of_teachers')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="教师性别" prop="gender_of_teachers">
								<el-select id="gender_of_teachers" v-model="form_sub['gender_of_teachers']"
						v-if="user_group === '管理员' || (form_sub['teacher_users_id'] && $check_field('set','gender_of_teachers')) || (!form_sub['teacher_users_id'] && $check_field('add','gender_of_teachers'))">
						<el-option v-for="o in list_gender_of_teachers" :key="o" :label="o" :value="o">
						</el-option>
					</el-select>
					<div v-else-if="$check_field('get','gender_of_teachers')">{{form_sub['gender_of_teachers']}}</div>
							</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','age_of_teachers') || $check_field('add','age_of_teachers') || $check_field('set','age_of_teachers')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="教师年龄" prop="age_of_teachers">
												<el-input id="age_of_teachers" v-model="form_sub['age_of_teachers']" placeholder="请输入教师年龄"
							  v-if="user_group === '管理员' || (form_sub['teacher_users_id'] && $check_field('set','age_of_teachers')) || (!form_sub['teacher_users_id'] && $check_field('add','age_of_teachers'))"></el-input>
					<div v-else-if="$check_field('get','age_of_teachers')">{{form_sub['age_of_teachers']}}</div>
											</el-form-item>
			</el-col>
			...
			return {
				...
				disabledObj:{
								"teachers_name_isDisabled": false,
										"gender_of_teachers_isDisabled": false,
										"age_of_teachers_isDisabled": false,
							},

				form_sub: {
								"teachers_name":  '', // 教师姓名
										"gender_of_teachers":  '', // 教师性别
										"age_of_teachers":  '', // 教师年龄
									    "user_id": 0,
