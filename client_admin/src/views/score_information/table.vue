		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','release_time')" min-width="200">
					...
					<el-table-column prop="award_and_excellence_evaluation" @sort-change="$sortChange" label="评奖评优"
				v-if="user_group == '管理员' || $check_field('get','award_and_excellence_evaluation')" min-width="200">
					</el-table-column>
					<el-table-column prop="score_details" @sort-change="$sortChange" label="成绩详情"
				v-if="user_group == '管理员' || $check_field('get','score_details')" min-width="200">
					</el-table-column>
